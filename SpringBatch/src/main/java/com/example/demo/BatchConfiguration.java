...
public class BatchConfiguration {
	...
	@Bean
	public ItemReader<Person> csvFileReader() {
	...
	public Job csvFileToCsvJob(JobCompletionNotificationListener listener) throws IOException {
		return jobBuilderFactory.get("csvFileToCsvJob").incrementer(new RunIdIncrementer()).listener(listener)
				.flow(csvFileToCsvStep()).end().build();
	}
	...
	@Bean 
	public static  JobCompletionNotificationListener jobCompletionNotificationListener() {
