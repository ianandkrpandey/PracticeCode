...
public class PutDataExample {
    ...
    public static void main(String args[]) {
        ...
        BasicAWSCredentials awsCreds = new BasicAWSCredentials("AKIAIZT3V6OAACUPHOLQ", "UW9LRfPqcJgzhpM1LFA6IWHPc+scJxvtcZm1mgJy");
        ...
        putRecordRequest.setStreamName("StreamFromJava"); //name of aws stream you created
        ...
        getShardIteratorRequest.setStreamName("c6-cd-dev-ks");
